...
export default [
  {
    ...
    options: {"staleWhileRevalidate":{"cacheName":"v1.2.19","routes":["/contact","/blog"],"fileTypes":["document","script","style","image"]},"cacheFirst":{"cacheName":"cf-v1","routes":[],"fileTypes":[]},"cacheOnly":{"cacheName":"co-v1","routes":[],"fileTypes":[]},"networkFirst":{"cacheName":"nf-v1","routes":[],"fileTypes":[]},"networkOnly":{"cacheName":"no-v1","routes":[],"fileTypes":[]},"precachedRoutes":[]}
  },
  {
