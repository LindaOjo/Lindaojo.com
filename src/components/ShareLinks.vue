            ...
            <div class="mx-10">
                ...
                <button>
                    <ShareNetwork
                        ...
                        <span class="share-button h-auto mr-8">
                            <svg class="inline"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#4d9cec" width="25px" height="25px">
                ...
                <ShareNetwork
                    ...
                    <span class="share-button h-auto mt-4 mr-8">
                        <svg class="inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#4d9cec" width="25px" height="25px">
                ...
                <ShareNetwork
                    ...
                    :description="excerpt"
                    hashtags="Frontend,Programming">
                    <span class="share-button h-auto mt-4">
                        <svg class="inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="#4d9cec" width="25px" height="25px">
