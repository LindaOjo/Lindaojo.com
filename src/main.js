...
export default function (Vue, { router, head, isClient }) {
    ...
    head.meta.push(
        ...
        {key: "og:image", property: "og:image", content:"https://res.cloudinary.com/lindaojo/image/upload/v1605041276/icon-144_itx9ug.png"},
        ...
        {key: "twitter:image", property: "twitter:image", content:"https://res.cloudinary.com/lindaojo/image/upload/v1605041276/icon-144_itx9ug.png"},
