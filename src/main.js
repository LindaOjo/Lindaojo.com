...
export default function (Vue, { router, head, isClient }) {
    ...
    head.meta.push(
        ...
        {key: "og:image", property: "og:image", content:"https://res.cloudinary.com/lindaojo/image/upload/v1604242086/icon-512_eutvzh.png"},
        ...
        {key: "twitter:image", property: "twitter:image", content:"https://res.cloudinary.com/lindaojo/image/upload/v1604242086/icon-512_eutvzh.png"},
