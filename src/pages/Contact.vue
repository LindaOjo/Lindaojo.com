    ...
    <div class="fade-in">
        ...
        <div class="links sm:w-3/4 lg:w-1/2 mx-auto flex" >
            <p class=" inline-flex w-full justify-center mt-5">
                    ...
                    <a class="flex flex-col items-center" href='https://res.cloudinary.com/lindaojo/image/upload/v1616439329/Resume_-_Linda_Ojo_naufv0.pdf' target="_blank" rel="noopener">
